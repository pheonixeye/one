...
class PiSupplyItemsApi extends PiApi<PiReferral> {
  ...
  @override
  Future<ApiResult<List<PiReferral>>> fetchDoctorItems() async {
    try {
      ...
      final _items = _result.items
          .map((e) => PiReferral.fromJson(e.toJson()))
          .toList();

      return ApiDataResult<List<PiReferral>>(data: _items);
    } catch (e) {
      return ApiErrorResult<List<PiReferral>>(
