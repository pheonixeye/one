...
// import 'package:one/models/subscription__OLD.dart';
...
//       //@handle
//       dprint(e);
//       throw CodedException(message: 'No Payment Reference Found.', code: 10);
//     }
//     final _payment = Payment__OLD.fromJson(_subPaymentGetQuery.toJson());
