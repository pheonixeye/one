...
class VisitDataApi {
  ...
  final String _expand =
      'patient_id, labs_ids, rads_ids, procedures_ids, drugs_ids, supplies_ids, forms_data_ids, forms_data_ids.form_id, forms_data_ids.form_id.fields, visit_id, doc_id, clinic_id';
